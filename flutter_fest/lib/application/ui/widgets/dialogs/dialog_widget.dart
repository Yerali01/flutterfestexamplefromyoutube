...
class DialogWidget extends StatelessWidget {
  ...
  const DialogWidget({super.key, required this.configuration});
  ...
  Widget build(BuildContext context) {
    ...
    return BackdropFilter(
      ...
      child: Theme(data: ThemeData.dark(), child: dialog),
    );
  }
...
class _MaterialDialogWidget extends StatelessWidget {
  ...
  const _MaterialDialogWidget({super.key, required this.configuration});
...
class _ActionWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextButton(
      ...
      child: Text(
        configuration.title,
        style: style.copyWith(color: AppColor.green),
      ),
    );
  }
}
