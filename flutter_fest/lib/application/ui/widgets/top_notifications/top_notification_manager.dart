...
class TopNotificationManagerWidget extends StatefulWidget {
  final Widget? child;
  const TopNotificationManagerWidget({super.key, required this.child});
...
class _TopNotificationManagerWidgetState
  ...
  Widget build(BuildContext context) {
    ...
    final topNotificationOverlayWidget =
        TopNotificationOverlayWidget(key: _topNotificationOverlayKey);
